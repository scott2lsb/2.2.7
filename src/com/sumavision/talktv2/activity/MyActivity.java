...
public class MyActivity extends Activity implements OnClickListener,
	...
	protected void onResume() {
		...
		if (UserNow.current().userID != 0) {
			ucScroll.smoothScrollTo(-2000, -2000);
			showLoginLayout();
			updateUserInfo();
			showTipImage();
		} else {
	...
	private void initEventInfo() {
		...
		ucScroll = (ScrollView) findViewById(R.id.scollView);
	...
	public void onClick(View v) {
		...
		case R.id.medal_layout:
			...
			ActivititesActivity.fromMy = 1;
			MainTabActivityNew.tabHost.setCurrentTabByTag("activities");
			MainTabActivityNew.activitiesBtn.setChecked(true);
			break;
		case R.id.refresh:
			getUserInfo();
			break;
