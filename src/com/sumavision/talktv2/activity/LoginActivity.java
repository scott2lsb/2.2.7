...
import com.sumavision.talktv2.net.LoginNewRequest;
...
public class LoginActivity extends Activity implements OnClickListener,
	...
	private final NetServer server = NetServer.current();
	...
	private void initView() {
		all = (FrameLayout) findViewById(R.id.userlogin_main);
		...
		main = (FrameLayout) findViewById(R.id.userlogin_main);
	...
	public void bindLogin() {
		...
		server.addListener(this);
		server.service(new BindUserRequest(), new BindUserParser());
	}
