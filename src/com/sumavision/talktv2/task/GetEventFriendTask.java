...
public class GetEventFriendTask extends AsyncTask<Object, Void, String> {
	private final String TAG = "GetEventFriendTask";
	private final NetConnectionListener listener;
	private final String method = "eventFriendList";

	public GetEventFriendTask(NetConnectionListener listener) {
