 ...
 * @description 获取其他人预约信息
 * @changLog
 */
public class GetOtherRemindTask extends AsyncTask<Object, Void, String> {
	private final String TAG = "GetOtherRemindTask";
	private final NetConnectionListener listener;
	private final String method = "remindList";

	public GetOtherRemindTask(NetConnectionListener listener) {
	...
	protected String doInBackground(Object... params) {
		Context context;
		OtherUserRemindRequest request;
		OtherUserRemindParser parser;
		String data;
		context = (Context) params[0];
		request = (OtherUserRemindRequest) params[1];
		parser = (OtherUserRemindParser) params[2];
		data = request.make();
