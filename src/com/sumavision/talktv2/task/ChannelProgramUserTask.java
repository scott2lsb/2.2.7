 ...
 * 
 */
public class ChannelProgramUserTask extends AsyncTask<Object, Integer, Integer> {
	...
	public ChannelProgramUserTask(NetConnectionListenerNew listener,
			boolean isLoadMore) {
		method = Constants.channelProgramUser;
	...
	private String generateRequset(int userId, int first, int count, int cctv) {
		...
		Log.e("ChannelProgramUserTask", returnValue);
		return returnValue;
	}
